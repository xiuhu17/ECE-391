...
// Use as bit mask to get each specific bit value of Byte0 
#define MOUSE_Y0 	    0x80                // 0b 1000 0000
#define MOUSE_X0 	    0x40                // 0b 0100 0000
#define MOUSE_YS 	    0x20                // 0b 0010 0000
#define MOUSE_XS 	    0x10                // 0b 0001 0000
#define MOUSE_MIDDLE 	0x04                // 0b 0000 0100
#define MOUSE_RIGHT	    0x02                // 0b 0000 0010
#define MOUSE_LEFT	    0x01                // 0b 0000 0001
...
#define MTCP_ACK	        MTCP_RESP(0x0) // Response when the MTC successfully completes a command.

#define MTCP_BIOC_EVENT	    MTCP_RESP(0x1)
#define MTCP_CLK_EVENT	    MTCP_RESP(0x2)
#define MTCP_OFF_EVENT	    MTCP_RESP(0x3)

#define MTCP_POLL_OK	    MTCP_RESP(0x4)          // a response to a poll
...
#define MTCP_CMD_CHECK              0xC0            // 1100 0000
...
;	increasing LED number. (e.g LED0, LED2, LED3 for a bitmask of 0x0D = 0000 1101)
;
; 	Response: 1 byte
;		byte 0 - MTCP_ACK
;
...
;	In picto-gram form:
;	Packet 0 will be:
;   The only difference here is Byte0[2]
; 	  +-7-+-6-+-5-+--4-+-3-+-2-+-1--+-0--+
; 	0 | 0 | 1 | 0 |  1 | 0 | 0 | A1 | A0 | 
; 	  +---+---+---+----+---+---+----+----+
